...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Launch a browser
    , ((modm              , xK_o     ), spawn myNavigator)

    -- Take a screenshot
    , ((modm .|. shiftMask, xK_s     ), spawn "scrot -e 'mv $f ~/screenshots/'")
...
myLogHook h = dynamicLogWithPP $ defaultPP
    {
      ...
      , ppHidden            =   dzenColor "#bbbbbb" "#000000" . pad
      , ppHiddenNoWindows   =   dzenColor "#4b4b4b" "#000000" . pad
